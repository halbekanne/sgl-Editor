...
public final class SwingUtils {
	...
	private static <T extends JComponent> T getComponentFromList(Class<T> clazz, List<T> list,
		...
		try {
			...
			try {
				...
				throw new IllegalArgumentException("Property " + property + " not found in class "
						+ clazz.getName());
			}
		}
		try {
			...
			throw new IllegalArgumentException("Error accessing property " + property
	 ...
	 *            the accessor e.g. "Text" for getText(), "Value" for
	 *            getValue(). This parameter is case sensitive.
	 * @param value
	 ...
	 *             if the bound property does not exist for the class or cannot
	 *             be accessed
	 */
	public static <T extends JComponent> T getDescendantOfClass(Class<T> clazz,
			Container container, String property, Object value) throws IllegalArgumentException {
	 ...
	 *             be accessed
	 */
	public static <T extends JComponent> T getDescendantOfType(Class<T> clazz, Container container,
			String property, Object value) throws IllegalArgumentException {
	 ...
	 *            the value of the bound property
	 * @param nested
	 *            true to list components nested within another component which
	 *            is also an instance of <code>clazz</code>, false otherwise
	 * @return the component, or null if no such component exists in the
	 *         container
	 * @throws java.lang.IllegalArgumentException
	 *             if the bound property does not exist for the class or cannot
	 ...
	 */
	public static <T extends JComponent> T getDescendantOfType(Class<T> clazz, Container container,
			String property, Object value, boolean nested) throws IllegalArgumentException {
	 ...
	 */
	public static <T extends JComponent> List<T> getDescendantsOfClass(Class<T> clazz,
			Container container) {
	 ...
	 */
	public static <T extends JComponent> List<T> getDescendantsOfClass(Class<T> clazz,
			Container container, boolean nested) {
		...
		for (Component component : container.getComponents()) {
			...
			if (nested || !clazz.equals(component.getClass())) {
				tList.addAll(SwingUtils.<T> getDescendantsOfClass(clazz, (Container) component,
						nested));
			}
		}
		return tList;
	 ...
	 * @return the List of components
	 */
	public static <T extends JComponent> List<T> getDescendantsOfType(Class<T> clazz,
			Container container) {
	...
	public static <T extends JComponent> List<T> getDescendantsOfType(Class<T> clazz,
		...
		for (Component component : container.getComponents()) {
			...
			if (nested || !clazz.isAssignableFrom(component.getClass())) {
				tList.addAll(SwingUtils.<T> getDescendantsOfType(clazz, (Container) component,
						nested));
			}
		}
		return tList;
